...
- (void)viewDidLoad
{
    ...
    //初始化红，蓝，黄三个界面
    UIView *redView = [[UIView alloc]initWithFrame:CGRectMake(0, 60, 320, 300)];
    ...
    UIView *blueView = [[UIView alloc]initWithFrame:CGRectMake(0, 60, 320, 300)];
    blueView.tag = 102;
    ...
    UIView *yellowView = [[UIView alloc]initWithFrame:CGRectMake(0, 60, 320, 300)];
