...
@interface newLineStringViewController ()

@end

@implementation newLineStringViewController
...
- (void)viewDidLoad
{
    ...
    newlineString *string = [[newlineString alloc]init];
